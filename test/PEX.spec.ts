...
describe('evaluate', () => {
  ...
  it('Evaluate case multiple presentations multiple formats submission provided not satisfying definition no submission_requirements with error 1', () => {
    ...
    expect(evaluationResults).toEqual({
      ...
      errors: [
        {
          message:
            "Expected all input descriptors ('867bfe7a-5b91-46b2-9ba4-70028b8d9cc8', 'f09f7000-6bf2-4239-8e8d-13014e681eba', 'ddc4a62f-73d4-4410-a3d7-b20720a113ed', 'e0556bbf-d1c0-48d8-8564-09f6e07bac9b') to be satisfied in submission, but found '867bfe7a-5b91-46b2-9ba4-70028b8d9cc8','f09f7000-6bf2-4239-8e8d-13014e681eba','e0556bbf-d1c0-48d8-8564-09f6e07bac9b'. Missing 'ddc4a62f-73d4-4410-a3d7-b20720a113ed'",
          status: 'error',
  ...
  it('Evaluate case multiple presentations multiple formats submission provided not satisfying definition with submission_requirements with error 1', () => {
    ...
    expect(evaluationResults).toEqual({
      ...
      errors: [
        {
          message: 'Expected all submission requirements (1) to be satisfied in submission, but found 0.',
          status: 'error',
          tag: 'SubmissionDoesNotSatisfyDefinition',
        },
      ],
  ...
  it('handles the case where the ids in the submission do not match with the ids from the presentation definition', () => {
    ...
    const submission = {
      ...
      definition_id: 'does-not-match',
      descriptor_map: [{ id: 'does-also-not-match', format: 'vc+sd-jwt', path: '$' }],
    };
    ...
    expect(result).toEqual({
      ...
      errors: [
        {
          message: "Presentation submission defines definition_id 'does-not-match', but the provided definition has id '0ne55k'",
          status: 'error',
          tag: 'SubmissionDefinitionIdNotFound',
        },
        {
          message:
            "Submission references descriptor id 'does-also-not-match' but presentation definition with id '0ne55k' does not have an input descriptor with this id. Available input descriptors are '87d6k'",
          status: 'error',
          tag: 'SubmissionInputDescriptorIdNotFound',
        },
        {
          message: "Expected all input descriptors ('87d6k') to be satisfied in submission, but found 'does-also-not-match'. Missing '87d6k'",
          status: 'error',
          tag: 'SubmissionDoesNotSatisfyDefinition',
        },
      ],
  ...
  it('allows optional value in field definition', () => {
